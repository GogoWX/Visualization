...
//用户数据切换
function changeD() {
    let chooseD = $('#users-date').val();
    console.log('xxxxx', chooseD)
    let xdata = ['上海', '广州', '北京', '深圳', '合肥', '杭州', '厦门', '济南', '成都', '重庆'];
    let ydata = [2100, 1900, 1700, 1560, 1400, 900, 750, 600, 480, 240];
    if (chooseD == 0) {
        xdata = ['1', '2', '3', '4', '5'];
        ydata = [2100, 1900, 1700, 1560, 1400];
    }
